...
#include <ltzvisor_configuration_file.h>
...
extern spinlock_t active_OS_spinlock;

/*
Secure variables used to manage the OS
Placed at Secure OCRAM Addresses
*/
extern tzmachine NS_Guest;
extern tzmachine NS_Guests[CORE_NS_GUEST];
