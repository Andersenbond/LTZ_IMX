...
extern uint32_t nsguest_bin_start, nsguest_bin_end, nsguest_execution_address;

/** Config structure according to NS Guest */
struct nsguest_conf_entry nsguest_config[] ={
	{
		.gce_name = "IMX6-Baremetal",
		.gce_id = 0,
		/* No ram  disk needed */
		.gce_trd_init = 0,
		/* Binary image size */
		.gce_bin_start = (uint32_t) &nsguest_bin_start,
		.gce_bin_end = (uint32_t) &nsguest_bin_end,
		/* Load address */
		.gce_bin_load = &nsguest_bin_start, //nsguest_execution_address, ///0x00100000,
