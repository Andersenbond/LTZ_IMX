...
/******************************************************************************/
/******************************************************************************/
/*                            CORE 1,2,3 Stack pointers                       */
/******************************************************************************/
/******************************************************************************/

/** IRQ stack allocation (4-bit alligned) */
extern uint32_t _irq_stack_secondary[STACK_SIZE_SECONDARY/4];

/** FIQ stack allocation (4-bit alligned) */
extern uint32_t _fiq_stack_secondary[STACK_SIZE_SECONDARY/4];

/** ABORT stack allocation (4-bit alligned) */
extern uint32_t _abort_stack_secondary[STACK_SIZE_SECONDARY/4];

/** UNDEF stack allocation (4-bit alligned) */
extern uint32_t _undefined_stack_secondary[STACK_SIZE_SECONDARY/4];

/** SYS stack allocation (4-bit alligned) */
extern uint32_t _user_stack_secondary[STACK_SIZE_SECONDARY/4];

/** MON stack allocation (4-bit alligned) */
extern uint32_t _monitor_stack_secondary[STACK_SIZE_SECONDARY/4];

/** SVC stack allocation (4-bit alligned) */
extern uint32_t _supervisor_stack_secondary[STACK_SIZE_SECONDARY/4];
